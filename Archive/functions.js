...
function sendEmail() {
    Email.send({
        SecureToken: "567dd513-51d2-45ce-9ed9-9b4ebc22697f",
        To: document.getElementById("email").value,
        From: "contact.exchange.sami.mnif@gmail.com",
        Subject: "Exchange Contact with Sami Mnif",
        Body: "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
            ...
            "  <title></title>" +
            "    <style type=\"text/css\">" +
            "      table, td { color: #000000; } a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_text_1 .v-container-padding-padding { padding: 50px 20px 10px !important; } }" +
            ...
            "</style>" +
            "</head>" +
            "<body class=\"clean-body u_body\" style=\"margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #191e32;color: #000000\">" +
            "  <!--[if IE]><div class=\"ie-container\"><![endif]-->" +
            "  <!--[if mso]><div class=\"mso-container\"><![endif]-->" +
            "  <table style=\"border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #191e32;width:100%\" cellpadding=\"0\" cellspacing=\"0\">" +
            "  <tbody>" +
            "  <tr style=\"vertical-align: top\">" +
            "    <td style=\"word-break: break-word;border-collapse: collapse !important;vertical-align: top\">" +
            "    <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td align=\"center\" style=\"background-color: #191e32;\"><![endif]-->" +
            ...
            "  <h1 style=\"margin: 0px; line-height: 100%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: impact,chicago; font-size: 50px; color: white;\">" +
            "    Thank<br />You!" +
            "  </h1>" +
            "      </td>" +
            "    </tr>" +
            ...
            "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-family: 'trebuchet ms', geneva; font-size: 18px;\">Dear " + document.getElementById("name").value + " " + document.getElementById("lastName").value + ",</span></strong></span></p>" +
            "<p style=\"font-size: 14px; line-height: 190%;\">&nbsp;</p>" +
            "<p style=\"line-height: 190%; font-size: 14px;\"><span style=\"font-family: 'trebuchet ms', geneva; font-size: 14px; line-height: 26.6px;\"><span style=\"font-size: 16px; line-height: 30.4px;\">Thank you for exchanging your contacts with me.</span></span></p>" +
            "<p style=\"line-height: 190%; font-size: 14px;\"><span style=\"font-family: 'trebuchet ms', geneva; font-size: 14px; line-height: 26.6px;\"><span style=\"font-size: 16px; line-height: 30.4px;\">Attached is my VCF file where you can download it and then open to add my contact information directly to your phone's contacts list.</span></span></p>" +
            "<p style=\"line-height: 190%; font-size: 14px;\">&nbsp;</p>" +
            "<p style=\"line-height: 190%; font-size: 14px;\"><span style=\"font-family: 'trebuchet ms', geneva; font-size: 14px; line-height: 26.6px;\"><span style=\"font-size: 16px; line-height: 30.4px;\">Thanks again!</span></span></p>" +
            "<p style=\"font-size: 14px; line-height: 190%;\">&nbsp;</p>" +
...
function sendInfo() {
    Email.send({
        SecureToken: "567dd513-51d2-45ce-9ed9-9b4ebc22697f",
        To: ["samimnif@icloud.com", "samimnif2002@gmail.com"],
        From: "contact.exchange.sami.mnif@gmail.com",
        Subject: "New Contact saved",
        Body: "<font size=\"+1\"><b>New Contact: " +
            "</b> <br>Name: " + document.getElementById("name").value +
            "<br>Last Name: " + document.getElementById("lastName").value +
            "<br>Email: " + document.getElementById("email").value +
            "<br> <br> Submitted on: " + currentdate.getDate() + "/"
            + (currentdate.getMonth() + 1) + "/"
            + currentdate.getFullYear() + " @ "
            + currentdate.getHours() + ":"
            + currentdate.getMinutes() + ":"
            + currentdate.getSeconds() + "</font>"
    });
}
function hideShow() {
    var x = document.getElementById("tempForm");
...
function formHide() {
    var x = document.getElementById("formInside");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
